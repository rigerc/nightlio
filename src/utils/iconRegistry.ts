import {
  Activity, Apple, Baby, Bike, BookOpen, Brain, Briefcase, Car, CircleCheck,
  Clock, Cloud, CloudRain, Code, Coffee, Dumbbell, Flame, Frown, Gift, Globe,
  Gamepad2, Headphones, Heart, Home, Laugh, Leaf, Lightbulb, Laptop, Map, Meh,
  MessageCircle, Moon, Music, Pencil, Phone, Pill, Pizza, Plane, ShoppingBag,
  Smile, SmilePlus, Sparkles, Star, Sun, Sunset, Tag, Target, ThumbsDown,
  ThumbsUp, TreePine, Trophy, Users, Utensils, Wind, Zap, ZapOff, Camera,
  Droplets, Eye, Footprints, Tv, Waves, PersonStanding, type LucideProps,
} from 'lucide-react';
